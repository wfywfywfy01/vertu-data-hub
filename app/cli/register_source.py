...
SOURCES = [
    dict(
        ...
        config={"path": "政策产品文档", "handler": "doc_rag", "oss_prefix": "raw/docs/", "default_tags": {"doc_type": "policy"}},
    ),
    dict(
        ...
        config={"path": "陈列装修图片", "handler": "image", "oss_prefix": "raw/images/", "default_tags": {"image_type": "display"}},
    ),
    dict(
        ...
        config={"path": "销售历史数据", "handler": "tabular", "oss_prefix": "raw/sales/", "dataset_code": "sales_history_import"},
    ),
    dict(
        ...
        config={"path": "其他-待定", "handler": "unclassified", "oss_prefix": "quarantine/"},
    ),
    dict(
